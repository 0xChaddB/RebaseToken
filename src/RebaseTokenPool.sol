...
import {IERC20} from "@ccip/contracts/src/v0.8/ccip/vendor/openzeppelin-solidity/v4.8.3/contracts/token/ERC20/IERC20.sol";
...
contract RebaseTokenPool is TokenPool {
    ...
    
    {
        ...
        lockOrBurnOut = Pool.LockOrBurnOutV1({
            ...
            destPoolData: abiencode(userInterestRate)
        });
    }
